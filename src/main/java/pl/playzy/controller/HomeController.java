...
import pl.playzy.dto.DeleteAccountDto;
import pl.playzy.dto.EmailUpdateDto;
import pl.playzy.dto.PasswordChangeDto;
import pl.playzy.dto.UserProfileDto;
import pl.playzy.dto.UsernameUpdateDto;
...
public class HomeController {
    ...
    public String dashboard(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        getCurrentUser(userDetails).ifPresent(user -> addDashboardAttributes(model, user));
        return "dashboard";
    }
